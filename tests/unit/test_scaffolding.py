...
def test_project_structure_directories():
    ...
    expected_dirs = [
        ...
        base_dir / "src" / "application" / "port" / "inbound",
        base_dir / "src" / "application" / "port" / "outbound",
        base_dir / "src" / "application" / "service",
        base_dir / "src" / "adapter",
        base_dir / "src" / "adapter" / "inbound",
        base_dir / "src" / "adapter" / "inbound" / "cli",
        base_dir / "src" / "adapter" / "inbound" / "llm",
        base_dir / "src" / "adapter" / "outbound",
        base_dir / "src" / "adapter" / "outbound" / "persistence",
        base_dir / "src" / "adapter" / "outbound" / "llm",
        base_dir / "dataset",
        base_dir / "tests",
        base_dir / "tests" / "unit",
...
def test_package_imports():
    ...
    import src.application.port.inbound
    import src.application.port.outbound
    import src.application.service
    import src.adapter
    import src.adapter.inbound
    import src.adapter.inbound.cli
    import src.adapter.inbound.llm
    import src.adapter.outbound
    import src.adapter.outbound.persistence
    import src.adapter.outbound.llm
