...
- [COMPLETED] [TEST001-01] [Type: Unit] **test_project_structure_directories**
...
- [COMPLETED] [TEST001-02] [Type: Unit] **test_required_configuration_files**
...
- [COMPLETED] [TEST001-03] [Type: Unit] **test_env_example_contains_essential_keys**
...
- [COMPLETED] [TEST001-04] [Type: Unit] **test_package_imports**
...
- [COMPLETED] [TEST001-05] [Type: Unit] **test_sale_record_properties**
...
- [COMPLETED] [TEST001-06] [Type: Unit] **test_sale_record_unpromoted**
...
- [COMPLETED] [TEST001-07] [Type: Unit] **test_metric_results_instantiation**
...
- [COMPLETED] [TEST001-08] [Type: Unit] **test_get_top_selling_product**
...
- [COMPLETED] [TEST001-09] [Type: Unit] **test_get_top_selling_product_empty**
...
- [COMPLETED] [TEST001-10] [Type: Unit] **test_get_top_locations_by_volume**
...
- [COMPLETED] [TEST001-11] [Type: Unit] **test_get_total_sales_in_period**
...
- [COMPLETED] [TEST001-12] [Type: Unit] **test_compare_planned_vs_actual_quantity**
...
- [COMPLETED] [TEST001-13] [Type: Unit] **test_analyze_promotion_impact**
...
- [COMPLETED] [TEST001-14] [Type: Unit] **test_analyze_service_level_bottlenecks**
...
- [COMPLETED] [TEST001-15] [Type: Unit] **test_calculate_revenue_deficit**
...
- [COMPLETED] [TEST001-16] [Type: Unit] **test_calculate_average_discount**
...
- [COMPLETED] [TEST001-17] [Type: Unit] **test_identify_sales_seasonality**
...
- [COMPLETED] [TEST001-18] [Type: Unit] **test_calculate_price_elasticity**
...
- [COMPLETED] [TEST001-19] [Type: Unit] **test_sales_metrics_service_delegation_to_ports**
...
- [COMPLETED] [TEST001-20] [Type: Unit] **test_execute_custom_query_port_delegation**
...
- [COMPLETED] [TEST001-21] [Type: Unit] **test_duckdb_sales_adapter_initialization**
...
- [COMPLETED] [TEST001-22] [Type: Unit] **test_duckdb_sales_adapter_get_sales_by_filter**
...
- [COMPLETED] [TEST001-23] [Type: Unit] **test_duckdb_sales_adapter_execute_read_only_query**
...
- [COMPLETED] [TEST001-24] [Type: Unit] **test_duckdb_sales_adapter_missing_csv**
...
- [COMPLETED] [TEST001-25] [Type: Unit] **test_create_domain_tools_count**
...
- [COMPLETED] [TEST001-26] [Type: Unit] **test_domain_tools_invocation_and_formatting**
...
- [COMPLETED] [TEST001-27] [Type: Unit] **test_secured_sql_tool_valid_select**
...
- [COMPLETED] [TEST001-28] [Type: Unit] **test_secured_sql_tool_blocks_dml_ddl**
...
- [COMPLETED] [TEST001-29] [Type: Unit] **test_llm_factory_default_environment**
...
- [COMPLETED] [TEST001-30] [Type: Unit] **test_llm_factory_google_alias_normalization**
...
- [COMPLETED] [TEST001-31] [Type: Unit] **test_system_prompt_contains_critical_sections**
...
- [COMPLETED] [TEST001-32] [Type: Unit] **test_sales_agent_ask_execution**
...
- [COMPLETED] [TEST001-33] [Type: Unit] **test_cli_main_interaction_and_exit_flow**
...
- [COMPLETED] [TEST001-34] [Type: Integration] **test_e2e_domain_tools_flows**
...
- [COMPLETED] [TEST001-35] [Type: Integration] **test_e2e_sql_fallback_and_missing_tool_log**
...
- [COMPLETED] [TEST001-36] [Type: Integration] **test_e2e_sql_fallback_security_rejection**
...
- [COMPLETED] [TEST001-37] [Type: Integration] **test_e2e_bootstrap_agent_flow**
...
- [COMPLETED] [TEST001-38] [Type: Unit] **test_dockerfile_and_readme_readiness**
