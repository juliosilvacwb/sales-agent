...
- [x] [TEST001-01] [Type: Unit] **test_project_structure_directories**
...
- [x] [TEST001-02] [Type: Unit] **test_required_configuration_files**
...
- [x] [TEST001-03] [Type: Unit] **test_env_example_contains_essential_keys**
...
- [x] [TEST001-04] [Type: Unit] **test_package_imports**
...
- [x] [TEST001-05] [Type: Unit] **test_sale_record_properties**
...
- [x] [TEST001-06] [Type: Unit] **test_sale_record_unpromoted**
...
- [x] [TEST001-07] [Type: Unit] **test_metric_results_instantiation**
...
- [x] [TEST001-08] [Type: Unit] **test_get_top_selling_product**
...
- [x] [TEST001-09] [Type: Unit] **test_get_top_selling_product_empty**
...
- [x] [TEST001-10] [Type: Unit] **test_get_top_locations_by_volume**
...
- [x] [TEST001-11] [Type: Unit] **test_get_total_sales_in_period**
...
- [x] [TEST001-12] [Type: Unit] **test_compare_planned_vs_actual_quantity**
...
- [x] [TEST001-13] [Type: Unit] **test_analyze_promotion_impact**
...
- [x] [TEST001-14] [Type: Unit] **test_analyze_service_level_bottlenecks**
...
- [x] [TEST001-15] [Type: Unit] **test_calculate_revenue_deficit**
...
- [x] [TEST001-16] [Type: Unit] **test_calculate_average_discount**
...
- [x] [TEST001-17] [Type: Unit] **test_identify_sales_seasonality**
...
- [x] [TEST001-18] [Type: Unit] **test_calculate_price_elasticity**
...
- [x] [TEST001-19] [Type: Unit] **test_sales_metrics_service_delegation_to_ports**
...
- [x] [TEST001-20] [Type: Unit] **test_execute_custom_query_port_delegation**
...
- [x] [TEST001-21] [Type: Unit] **test_duckdb_sales_adapter_initialization**
...
- [x] [TEST001-22] [Type: Unit] **test_duckdb_sales_adapter_get_sales_by_filter**
...
- [x] [TEST001-23] [Type: Unit] **test_duckdb_sales_adapter_execute_read_only_query**
...
- [x] [TEST001-24] [Type: Unit] **test_duckdb_sales_adapter_missing_csv**
...
- [x] [TEST001-25] [Type: Unit] **test_create_domain_tools_count**
...
- [x] [TEST001-26] [Type: Unit] **test_domain_tools_invocation_and_formatting**
...
- [x] [TEST001-27] [Type: Unit] **test_secured_sql_tool_valid_select**
...
- [x] [TEST001-28] [Type: Unit] **test_secured_sql_tool_blocks_dml_ddl**
...
- [x] [TEST001-29] [Type: Unit] **test_llm_factory_default_environment**
...
- [x] [TEST001-30] [Type: Unit] **test_llm_factory_google_alias_normalization**
...
- [x] [TEST001-31] [Type: Unit] **test_system_prompt_contains_critical_sections**
...
- [x] [TEST001-32] [Type: Unit] **test_sales_agent_ask_execution**
...
- [x] [TEST001-33] [Type: Unit] **test_cli_main_interaction_and_exit_flow**
...
- [x] [TEST001-34] [Type: Integration] **test_e2e_domain_tools_flows**
...
- [x] [TEST001-35] [Type: Integration] **test_e2e_sql_fallback_and_missing_tool_log**
...
- [x] [TEST001-36] [Type: Integration] **test_e2e_sql_fallback_security_rejection**
...
- [x] [TEST001-37] [Type: Integration] **test_e2e_bootstrap_agent_flow**
...
- [x] [TEST001-38] [Type: Unit] **test_dockerfile_and_readme_readiness**
